    ...
    <main class="chat-shell">
        <div class="chat-card">
            <section class="chat-header">
                <div>
                    <h1 class="badge"><i class="fa-solid fa-robot"></i>Chat de IA</h1>
                    <!-- <p class="subtitle">Converse com o assistente virtual em um layout claro, moderno e com tom roxo.</p> -->
                </div>
            </section>
